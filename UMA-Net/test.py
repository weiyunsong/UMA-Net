...
parser.add_argument('--model', default='MA-2', type=str, help='model name')
parser.add_argument('--model_weight', default='./result/RESIDE-OUT/MA-2/MA-2.pth', type=str, help='model weight file name')
