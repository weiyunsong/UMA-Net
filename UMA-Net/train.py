...
parser.add_argument('--model', default='MA-2', type=str, help='model')
parser.add_argument('--model_name', default='MA.py', type=str, help='model name')
parser.add_argument('--num_workers', default=8, type=int, help='number of workers')
parser.add_argument('--no_autocast', action='store_false', default=True, help='disable autocast')
parser.add_argument('--save_dir', default='./result', type=str, help='path to models saving')
parser.add_argument('--resume_checkpoint', default=True, type=bool,help='resume checkpoint')
...
if __name__ == '__main__':
    ...
    criterion = []
    criterion.append(nn.MSELoss().cuda())    #default_set L1loss
